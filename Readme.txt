...
if neither of these worked or if you are on linux open up your command 
line terminal and navigate to the Nodejs folder, then enter the command 
"node ../src/Core.js" to start the server. 
